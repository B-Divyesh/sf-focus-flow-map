...
const SHELL = ['/', '/privacy/', '/terms/', '/404.html', '/demo-boot.js', '/fonts/plex-sans.woff2', '/fonts/plex-mono.woff2', '/assets/mark.svg', '/assets/hero-blueprint-768.webp', ...__SHELL_ASSETS__];
